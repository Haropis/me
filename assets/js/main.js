...
sr.reveal('.home__scroll', {delay: 10})
sr.reveal('.home__img', {origin:'right', delay: 50})
...
sr.reveal('.about__social-icon', {delay: 200, interval: 100})
...
sr.reveal('.contact__text', {interval: 140})
sr.reveal('.contact__input', {delay: 230})
sr.reveal('.contact__button', {delay: 270})
